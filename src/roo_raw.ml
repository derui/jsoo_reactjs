...
(function () {
  ...
  return function _createClass(React, spec) {
    return function (_React$Component) {
      ...
      _createClass2(_class, [{
        ...
        value: function render() {
          ...
          throw new Error("render must define in component spec");
        }
      }, {
        ...
        value: function (_shouldComponentUpdate) {
          ...
          shouldComponentUpdate.toString = function () {
            return _shouldComponentUpdate.toString();
          };
